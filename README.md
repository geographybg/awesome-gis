...
- [Сравнение на реалните размери на  държавите в света](https://www.thetruesize.com/) - Възможност за сравнение на реалните размери на  държавите в света, без деформациите при проекцията на Меркатор.
