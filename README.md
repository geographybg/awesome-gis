...
- [CadastreBG](https://kais.cadastre.bg/bg/Map) :heavy_dollar_sign: - Интерактивена кадастрална карта на България, с възможност за закупуване на данни за избрани имоти, сгради и самостоятелни обекти на собственост.
