...
- :star2: - отворен код и/или отворени данни
...
- [QGIS](https://qgis.org/) :star2: :baby: - Най-разпространеният и богат на функционалности безплатен и отворен ГИС софтуер.


### Мобилни

- [QField](https://qfield.org/) :star2: :baby: - Цялата сила на QGIS в ръцете ти, безплатно. Мобилна версия на QGIS. 
...
- [Leaflet](https://leafletjs.com/) :star2: :baby: - JavaScript библиотека за създаване на инстерактивни карти удобни за преглед и на мобилно устройство.
...
- [Национален статистически институт (НСИ)](https://www.nsi.bg/bg/content/766/статистически-данни) :star2: :baby: - Национален статистически институт на България. 
...
- [Световното замърсяване на въздуха](https://waqi.info/bg) - Световното замърсяване на въздуха: Индекс на качеството на въздуха в реално време.
